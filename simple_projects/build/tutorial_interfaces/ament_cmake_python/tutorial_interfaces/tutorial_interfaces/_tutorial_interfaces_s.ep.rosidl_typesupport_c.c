...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "tutorial_interfaces/srv/detail/add_four_ints__type_support.h"
...
static void * tutorial_interfaces__srv__add_four_ints__request__create_ros_message(void)
{
  return tutorial_interfaces__srv__AddFourInts_Request__create();
}

static void tutorial_interfaces__srv__add_four_ints__request__destroy_ros_message(void * raw_ros_message)
{
  tutorial_interfaces__srv__AddFourInts_Request * ros_message = (tutorial_interfaces__srv__AddFourInts_Request *)raw_ros_message;
  tutorial_interfaces__srv__AddFourInts_Request__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool tutorial_interfaces__srv__add_four_ints__request__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * tutorial_interfaces__srv__add_four_ints__request__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(tutorial_interfaces, srv, AddFourInts_Request);
...
_register_msg_type__srv__add_four_ints__request(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__request__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__request__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__request__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__request__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(tutorial_interfaces, srv, AddFourInts_Request),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
...
static void * tutorial_interfaces__srv__add_four_ints__response__create_ros_message(void)
{
  return tutorial_interfaces__srv__AddFourInts_Response__create();
}

static void tutorial_interfaces__srv__add_four_ints__response__destroy_ros_message(void * raw_ros_message)
{
  tutorial_interfaces__srv__AddFourInts_Response * ros_message = (tutorial_interfaces__srv__AddFourInts_Response *)raw_ros_message;
  tutorial_interfaces__srv__AddFourInts_Response__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool tutorial_interfaces__srv__add_four_ints__response__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * tutorial_interfaces__srv__add_four_ints__response__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(tutorial_interfaces, srv, AddFourInts_Response);
...
_register_msg_type__srv__add_four_ints__response(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__response__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__response__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__response__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&tutorial_interfaces__srv__add_four_ints__response__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(tutorial_interfaces, srv, AddFourInts_Response),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
...
ROSIDL_GENERATOR_C_IMPORT
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tutorial_interfaces, srv, AddFourInts)();
...
_register_srv_type__srv__add_four_ints(PyObject * pymodule)
{
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tutorial_interfaces, srv, AddFourInts)(),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
