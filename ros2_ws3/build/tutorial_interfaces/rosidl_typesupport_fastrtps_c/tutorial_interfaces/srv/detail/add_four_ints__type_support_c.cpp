...
#include "tutorial_interfaces/srv/detail/add_four_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddFourInts_Request__ros_msg_type = tutorial_interfaces__srv__AddFourInts_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _AddFourInts_Request__ros_msg_type * ros_message = static_cast<_AddFourInts_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: a
  {
    cdr >> ros_message->a;
  }
...
size_t get_serialized_size_tutorial_interfaces__srv__AddFourInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddFourInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__AddFourInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__srv__AddFourInts_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces__srv__AddFourInts_Request;
    is_plain =
      (
      offsetof(DataType, d) +
      last_member_size
...
static size_t _AddFourInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__srv__AddFourInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, srv, AddFourInts_Request)() {
...
using _AddFourInts_Response__ros_msg_type = tutorial_interfaces__srv__AddFourInts_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _AddFourInts_Response__ros_msg_type * ros_message = static_cast<_AddFourInts_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: sum
  {
    cdr >> ros_message->sum;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t get_serialized_size_tutorial_interfaces__srv__AddFourInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddFourInts_Response__ros_msg_type * ros_message = static_cast<const _AddFourInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__AddFourInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces
size_t max_serialized_size_tutorial_interfaces__srv__AddFourInts_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tutorial_interfaces__srv__AddFourInts_Response;
    is_plain =
      (
...
static size_t _AddFourInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__srv__AddFourInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, srv, AddFourInts_Response)() {
...
// already included above
// #include "tutorial_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tutorial_interfaces/srv/add_four_ints.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces, srv, AddFourInts)() {
